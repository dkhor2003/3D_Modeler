...
struct MyControlPointPushConstantData
{
    glm::mat4 transform{ 1.0f };
    glm::vec3 push_color{ 1.0f, 0.0f, 0.0f };
};

MyControlPointRenderSystem::MyControlPointRenderSystem(MyDevice& device, VkRenderPass renderPass, VkPrimitiveTopology topology)
    : m_myDevice{ device } 
{
...
MyControlPointRenderSystem::~MyControlPointRenderSystem()
{
    vkDestroyPipelineLayout(m_myDevice.device(), m_vkPipelineLayout, nullptr);
}

void MyControlPointRenderSystem::_createPipelineLayout()
{
    VkPushConstantRange pushConstantRange{};
    pushConstantRange.stageFlags = VK_SHADER_STAGE_VERTEX_BIT | VK_SHADER_STAGE_FRAGMENT_BIT;
    pushConstantRange.offset = 0;
    pushConstantRange.size = sizeof(MyControlPointPushConstantData);
...
void MyControlPointRenderSystem::_createPipeline(VkRenderPass renderPass, VkPrimitiveTopology topology)
{
    ...
    m_pMyPipeline = std::make_unique<MyPipeline>(
        m_myDevice,
        "shaders/control_point_shader.vert.spv",
        "shaders/simple_shader.frag.spv",
        pipelineConfig);
}

void MyControlPointRenderSystem::renderControlPoints(
...
void MyControlPointRenderSystem::_renderPointsLines(std::string name, MyFrameInfo& frameInfo, std::vector<MyGameObject>& gameObjects)
{
    ...
    for (auto& obj : gameObjects)
    {
        ...
        {
            MyControlPointPushConstantData push{};
            ...
            vkCmdPushConstants(
                ...
                0,
                sizeof(MyControlPointPushConstantData),
                &push);
